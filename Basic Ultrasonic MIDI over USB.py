...
sonar1 = adafruit_hcsr04.HCSR04(trigger_pin=board.GP17, echo_pin=board.GP16, timeout=1.0)
sonar2 = adafruit_hcsr04.HCSR04(trigger_pin=board.GP14, echo_pin=board.GP15, timeout=1.0)
...
while True:
    try:
        print(current_note)
        print("Sonar 1: " + str(int(sonar1.distance)))
        print("Sonar 2: " + str(int(sonar2.distance)))
